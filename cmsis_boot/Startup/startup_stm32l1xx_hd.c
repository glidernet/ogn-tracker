...
void (* const g_pfnVectors[])(void) =
{
  ...
  0,0,0,0,                             /*!< Reserved                          */
  vPortSVCHandler,                     /*!< SVCall handler (originally)       */
  DebugMon_Handler,                    /*!< Debug monitor handler             */
  0,                                   /*!< Reserved                          */
  xPortPendSVHandler,                  /*!< The PendSV handler (originally)   */
  xPortSysTickHandler,                 /*!< The SysTick handler (originally)  */
...
#pragma weak SDIO_IRQHandler = Default_Reset_Handler          
#pragma weak TIM5_IRQHandler = Default_Reset_Handler          
#pragma weak SPI3_IRQHandler = Default_Reset_Handler          
#pragma weak UART4_IRQHandler = Default_Reset_Handler         
#pragma weak UART5_IRQHandler = Default_Reset_Handler         
